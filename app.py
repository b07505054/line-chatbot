...
#             line_bot_api.reply_message(event.reply_token, sticker_message)
    ...
    '        有鄰里意見反應或需要協助的問題，考量鄰里居民的生活型態與意見反映習慣，除了上述群組討論或直接向里長反應外，我會進一步 #設置網路表單與line官方帳號收集里民問題、意見，並 #設定回覆期限、#定期回報處理進度，積極傾聽里民聲音。\n'+
                                       '  3. 消弭資訊不對稱，落實鄰里重要資訊公告\n'+
    '        除了過往未落實的紙本公告，我也會透過上述群組及官方帳號 ＃即時發布社區重要資訊，同時公告社區改善的相關事項。\n'+
